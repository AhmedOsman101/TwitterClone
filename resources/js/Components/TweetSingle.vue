...
<template>
  <div class="tweet pt-5 thinBorder-b">
    ...
    <p class="pl-5 text-gray-400" v-text="tweet.created_at"/>

    <p class="tweetBody pl-5 text-xs" v-text="tweet.body"/>

    <TweetFooter :tweet_id="tweet.id" class="thinBorder-t pl-5"/>
  </div>
</template>
